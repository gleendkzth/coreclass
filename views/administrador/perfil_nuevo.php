            ...
            <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo $perfil['estadisticas']['total_usuarios']; ?></p>
                        <p class="text-sm text-gray-600 mt-1">Usuarios</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo $perfil['estadisticas']['total_docentes']; ?></p>
                        <p class="text-sm text-gray-600 mt-1">Docentes</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo $perfil['estadisticas']['total_programas']; ?></p>
                        <p class="text-sm text-gray-600 mt-1">Programas</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo $perfil['estadisticas']['total_cursos']; ?></p>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                ...
                <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 uppercase mb-1">Permisos</p>
                            <p class="text-sm text-gray-800 font-medium"><?php echo htmlspecialchars($perfil['datos_especificos']['permisos']); ?></p>
                        </div>
                        <?php endif; ?>
                        <div>
