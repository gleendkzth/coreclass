            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="px-6 pb-6">
                    <div class="flex flex-col items-center -mt-16">
                        ...
                        <p class="mt-2 text-gray-600 text-center font-medium">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">
                                <?php echo $perfil['estadisticas']['cursos_asignados']; ?>
                            </p>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">
                                <?php echo $perfil['estadisticas']['tareas_publicadas']; ?>
                            </p>
                            <p class="text-xs text-gray-500 mt-1">Publicadas</p>
                        </div>
                        <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                            <span class="material-icons-round text-green-600 text-2xl">assignment</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-bold text-gray-900 flex items-center">
                        <span class="material-icons-round text-gray-700 mr-2">workspace_premium</span>
                        Información Académica
                    </h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700 uppercase tracking-wide flex items-center">
                                <span class="material-icons-round text-sm mr-1">category</span>
                                Especialidad
                            </label>
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-base text-gray-900 font-medium bg-red-50 px-4 py-3 rounded-lg border-l-4 border-red-500">
                                <?php echo htmlspecialchars($perfil['datos_especificos']['grado_academico']); ?>
                            </p>
                        </div>
                        <?php endif; ?>
                    </div>
