            ...
            <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo $perfil['estadisticas']['cursos_matriculados']; ?></p>
                        <p class="text-sm text-gray-600 mt-1">Cursos Matriculados</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo $perfil['estadisticas']['tareas_pendientes']; ?></p>
                        <p class="text-sm text-gray-600 mt-1">Tareas Pendientes</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <p class="text-2xl font-bold text-gray-800"><?php echo number_format($perfil['estadisticas']['promedio_general'], 2); ?></p>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                ...
                <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 uppercase mb-1">Programa de Estudio</p>
                            <p class="text-sm text-gray-800 font-medium"><?php echo htmlspecialchars($perfil['datos_especificos']['programa_nombre']); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if (isset($perfil['datos_especificos']['semestre'])): ?>
                        <div>
                            <p class="text-xs text-gray-500 uppercase mb-1">Semestre</p>
                            <p class="text-sm text-gray-800 font-medium"><?php echo htmlspecialchars($perfil['datos_especificos']['semestre']); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if (isset($perfil['datos_especificos']['fecha_ingreso'])): ?>
                        <div>
                            <p class="text-xs text-gray-500 uppercase mb-1">Fecha de Ingreso</p>
                            <p class="text-sm text-gray-800 font-medium"><?php echo date('d/m/Y', strtotime($perfil['datos_especificos']['fecha_ingreso'])); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if (isset($perfil['datos_especificos']['estado_matricula'])): ?>
                        <div>
                            <p class="text-xs text-gray-500 uppercase mb-1">Estado de Matrícula</p>
                            <?php 
                            ...
                            ?>
                            <span class="inline-flex items-center px-2 py-1 text-xs font-medium <?php echo $color_class; ?> rounded">
